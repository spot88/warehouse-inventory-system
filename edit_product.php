...
if(!$product){
 ...
 if(isset($_POST['product'])){
    $req_fields = array('product-title','product-categorie','product-quantity','ks_storage', 'saleing-price' );
   ...
   if(empty($errors)){
       ...
       $query  .=" ks_storage ='{$p_buy}', sale_price ='{$p_sale}', categorie_id ='{$p_cat}',media_id='{$media_id}'";
