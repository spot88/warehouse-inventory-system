                   ...
                   <i class="glyphicon glyphicon-th-large"></i>
                     ...
                     <span class="input-group-addon">
                       <i>Stk</i>
                                        ...
                                        <input type="number" class="form-control" name="ks_storage"
                                               placeholder="KS-lager">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="input-group">
                      ...
                      <span class="input-group-addon">
                        <i class="glyphicon glyphicon-info-sign"></i>
                                        ...
                                        <input type="number" class="form-control" name="product-number"
                                               placeholder="Siebelkode">
                                    </div>
                                </div>
                            </div>
                        </div>
